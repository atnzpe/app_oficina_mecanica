...
class MinhaContaView(ft.Column):
    def __init__(self, page: ft.Page):
        ...
        # --- Componentes ---
        self._senha_atual_field = ft.TextField(
            label="Senha Atual",
            password=True,
        ...
        self._nova_senha_field = ft.TextField(
            label="Nova Senha",
            password=True,
            can_reveal_password=True,
            width=AppDimensions.FIELD_WIDTH,
        ...
        self._confirmar_senha_field = ft.TextField(
        ...
        self.controls = [
            ...
            ft.Row(
                [
                    ft.ElevatedButton(
                        "Cancelar", on_click=lambda _: self.page.go("/dashboard"),tooltip="Voltar ao Dashboard"),
                    ft.ElevatedButton("Salvar Alterações", icon=ft.Icons.SAVE,
                                      on_click=lambda _: self.view_model.alterar_senha(),tooltip="Salvar nova senha"),
                ],
    ...
    def limpar_formulario(self):
        ...
        logger.debug(
            "View: Limpando campos do formulário de alteração de senha.")
    ...
    def _fechar_dialogo_e_agir(self, e):
        ...
        if self._acao_pos_dialogo:
            logger.debug(
                "View: Ação de callback (navegação) pós-diálogo agendada.")
